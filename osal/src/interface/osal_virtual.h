...
#ifndef OSAL_VIRTUAL_H_
#define OSAL_VIRTUAL_H_
...
public:
    ...
    virtual bool waitFor(OSALMutex &mutex, uint32_t timeout_ms) = 0;
...
public:
    ...
    void wait(OSALMutex &mutex) override { impl_.wait(mutex); }
    bool waitFor(OSALMutex &mutex, uint32_t timeout_ms) override { return impl_.waitFor(mutex, timeout_ms); }
