...
#define osThreadDef(name, priority, instances, stacksz)                                                              \
    ...
    const osThreadDef_t os_thread_def_##name = {                                                                     \
        ...
        {NULL, osThreadDetached, (instances == 1) ? (&os_thread_cb_##name) : NULL,                                   \
         ...
         ((stacksz) && (instances == 1)) ? (&os_thread_stack##name) : NULL, 8 * ((stacksz + 7) / 8), (priority), 0U, \
         0U}}
#endif
...
#define osMessageQDef(name, queue_sz, type)                       \
    ...
    const osMessageQDef_t os_messageQ_def_##name = {              \
        (queue_sz),                                               \
        {NULL, 0U, (&os_mq_cb_##name), sizeof(StaticQueue_t), (&os_mq_data_##name), sizeof(os_mq_data_##name)}}
#endif
