// dp_osal_port.h — Porting template for the osal library.
//
...
//        set(DP_OSAL_PORT_DIR ${CMAKE_CURRENT_SOURCE_DIR}/your_port_dir)
//
// That's it. No other files are needed.
//
// BACKEND OPTIONS:
//   DP_OSAL_BACKEND_POSIX    — std::thread, pthread, std::mutex, std::chrono
//                           Use for Linux, macOS, and POSIX-compatible hosts.
//   DP_OSAL_BACKEND_CMSIS_OS — osThreadNew, osMutexNew, osTimerNew, etc.
...
#define DP_OSAL_PORT_THREAD_MIN_STACK_SIZE 4096
#endif

#ifndef DP_OSAL_PORT_THREAD_DEFAULT_PRIORITY
#define DP_OSAL_PORT_THREAD_DEFAULT_PRIORITY 0
#endif
...
// #define DP_OSAL_PORT_THREAD_STACK_POINTER_FROM_ID(thread_id) \
...
//
// The function must be declared 'inline' because dp_osal_port.h is included
...
//
// DP_OSAL_TEST_ALL = 1  → enable every test component (recommended for first bring-up)
...
#define DP_OSAL_TEST_THREAD_ENABLED 1
#define DP_OSAL_TEST_CHRONO_ENABLED 1
#define DP_OSAL_TEST_MUTEX_ENABLED 1
#define DP_OSAL_TEST_CONDITION_VARIABLE_ENABLED 1
#define DP_OSAL_TEST_LOCKGUARD_ENABLED 1
#define DP_OSAL_TEST_MEMORY_MANAGER_ENABLED 1
#define DP_OSAL_TEST_QUEUE_ENABLED 1
#define DP_OSAL_TEST_SEMAPHORE_ENABLED 1
#define DP_OSAL_TEST_SPINLOCK_ENABLED 1
#define DP_OSAL_TEST_RWLOCK_ENABLED 1
#define DP_OSAL_TEST_TIMER_ENABLED 1
#define DP_OSAL_TEST_THREAD_POOL_ENABLED 1
#endif
