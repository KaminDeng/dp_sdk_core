// dp_osal_port.h — Zephyr RTOS port using built-in CMSIS-RTOS v2 compatibility layer.
//
...
//
// DP_OSAL_PORT_THREAD_MIN_STACK_SIZE — 512 bytes, consistent with Zephyr's
//   default CONFIG_MAIN_STACK_SIZE for minimal targets.
// DP_OSAL_PORT_THREAD_DEFAULT_PRIORITY — osPriorityNormal from cmsis_os2.h.
// ═══════════════════════════════════════════════════════════════════════════════
#ifndef DP_OSAL_PORT_THREAD_MIN_STACK_SIZE
#define DP_OSAL_PORT_THREAD_MIN_STACK_SIZE 512
#endif
